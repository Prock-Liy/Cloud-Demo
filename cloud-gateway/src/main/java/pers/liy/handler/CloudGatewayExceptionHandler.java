 ...
 */
@Slf4j
public class CloudGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public CloudGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
